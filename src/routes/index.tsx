...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Freelance Graphic Designer in Marrakech | Branding & Logos" },
      {
        name: "description",
        content:
          "Freelance graphic designer in Marrakech creating unique, modern and striking visuals: logos, brand guidelines, visual identity, brandbooks, flyers and web design.",
      },
      {
        property: "og:title",
        content: "Freelance Graphic Designer in Marrakech | Branding & Logos",
      },
      {
        property: "og:description",
        content:
          "Years of experience building bold visual identities for brands across Morocco.",
      },
    ],
  }),
  component: Index,
...
const values = [
  ...
  {
    icon: BadgeCheck,
    title: "Guaranteed professional quality",
    text: "With professional tools and close attention to detail, I deliver high-quality graphic work suited to all of your visual needs.",
  },
];
...
const process = [
  {
    ...
    text: "The first step is studying the client's needs in detail to fully grasp their goals and vision. As a freelance graphic designer in Marrakech, I make sure every project is perfectly aligned with expectations and brand identity.",
  },
  {
...
const testimonials = [
  {
    quote:
      "I reached out while looking for a freelance graphic designer in Marrakech. His commitment, creativity and the quality of his work are simply exceptional.",
    name: "Lahcen M.",
  },
  {
    quote:
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative overflow-hidden border-b border-border">
        <div className="mx-auto grid max-w-6xl items-center gap-12 px-5 py-20 md:py-28 lg:grid-cols-[1.05fr_0.95fr]">
          <div>
            <p className="eyebrow">Freelance Graphic Designer · Marrakech</p>
            ...
            <p className="mt-6 max-w-xl text-base leading-relaxed text-muted-foreground">
              With several years of experience as a freelance graphic designer in Marrakech, I
              create unique, modern and striking visuals that elevate brands and deliver their
              message effectively. Every project is built on creativity, strategy and a deep
              understanding of how design generates real impact.
            </p>
      ...
      <section className="border-b border-border">
        <div className="mx-auto grid max-w-6xl gap-10 px-5 py-20 md:grid-cols-[0.8fr_1.2fr]">
          <h2 className="text-4xl md:text-5xl">Freelance graphic designer in Marrakech</h2>
          <p className="text-base leading-relaxed text-muted-foreground">
            As a graphic designer in Marrakech, I place great importance on transparent
            ...
            freelance graphic designer in Marrakech, I can also provide tailored, relevant advice
      ...
      <section id="projects" className="border-b border-border bg-secondary/40">
        <div className="mx-auto max-w-6xl px-5 py-20">
          ...
          <h2 className="mt-4 max-w-2xl text-4xl md:text-5xl">
            My work as a freelance graphic designer in Marrakech
          </h2>
          <p className="mt-5 max-w-2xl text-muted-foreground">
            Throughout my journey as a graphic designer in Marrakech, I have had the chance to work
      ...
      <section className="border-b border-border">
        <div className="mx-auto max-w-6xl px-5 py-20">
          ...
          <h2 className="mt-4 max-w-2xl text-4xl md:text-5xl">
            Working with me as a freelance graphic designer in Marrakech means…
          </h2>
      ...
      <section id="services" className="border-b border-border bg-ink text-ink-foreground">
        <div className="mx-auto max-w-6xl px-5 py-20">
          ...
          <h2 className="mt-4 max-w-2xl text-4xl md:text-5xl">
            Services as a freelance graphic designer in Marrakech
          </h2>
          <p className="mt-5 max-w-2xl opacity-70">
            As a freelance graphic designer in Marrakech, I offer the following services to meet my
      ...
      <section className="border-b border-border">
        <div className="mx-auto max-w-6xl px-5 py-20">
          ...
          <h2 className="mt-4 max-w-3xl text-4xl md:text-5xl">
            My working process, step by step, as a freelance graphic designer in Marrakech
          </h2>
      ...
      <section className="border-b border-border">
        <div className="mx-auto max-w-6xl px-5 py-20">
          ...
          <p className="mt-4 max-w-2xl text-muted-foreground">
            As a freelance graphic designer in Marrakech, I support clients with care all across
            Morocco. Every project becomes a shared success, built on trust and the quality of the
            work delivered.
          </p>
